 ...
 * @method static AuthenticatorInterfacee|ResetPasswordInterface|VerifyEmailInterface authenticate()
 ...
 * @method static AuthenticatorInterface|ResetPasswordInterface|VerifyEmailInterface|null user()
